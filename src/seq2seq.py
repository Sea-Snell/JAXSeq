...
def load_enc_dec_trainer(
    ...
    do_pjit: bool, 
    loss_fn: _LossFnType=enc_dec_loss, 
...
# load model parallel encdec jax inference

def load_enc_dec_inference(
    model: FlaxPreTrainedModel, 
    params: PyTree, 
    param_spec: Optional[Any], 
    tokenizer: PreTrainedTokenizer, 
    do_pjit: bool, 
    loss_fn: Optional[_LossFnType]=enc_dec_loss, 
    data_shard_spec: Seq2SeqDataShardSpec=Seq2SeqDataShardSpec(), 
) -> Seq2SeqInference:
...
# load model parallel dec jax trainer

def load_dec_trainer(
    model: FlaxPreTrainedModel, 
    params: PyTree, 
    param_spec: Optional[Any], 
    tokenizer: PreTrainedTokenizer, 
...
# load model parallel dec jax inference

def load_dec_inference(
    model: FlaxPreTrainedModel, 
    params: PyTree, 
    param_spec: Optional[Any], 
    tokenizer: PreTrainedTokenizer, 
    do_pjit: bool, 
    loss_fn: Optional[_LossFnType]=dec_loss, 
    data_shard_spec: Seq2SeqDataShardSpec=Seq2SeqDataShardSpec(), 
) -> Seq2SeqInference:

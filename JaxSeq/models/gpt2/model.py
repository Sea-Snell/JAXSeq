...
from JaxSeq.utils import multihost_device_get, multihost_device_put, get_gradient_checkpoint_policy
...
class FlaxGPT2PreTrainedModel(FlaxStreamGenerationMixin, FlaxPreTrainedModel):
    """

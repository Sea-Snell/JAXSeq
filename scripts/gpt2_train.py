...
import jax
import optax
from seq2seq import Seq2SeqInference, load_dec_inference, load_dec_trainer, load_enc_dec_trainer, load_enc_dec_inference
...
def main(
    ...
    model_name: str, # gpt2, gpt2-medium, gpt2-large, gpt2-xl [1.5B], gptj [6.5B]
